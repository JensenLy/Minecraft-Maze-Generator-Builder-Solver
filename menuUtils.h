...
void printGenerateMazeMenu(void){
    ...
    std::cout << "3) Read Maze from terminal and validate it to be a perfect"
    << " maze" << std::endl;
...
void printTeamInfo(void){
    ...
    std::cout << "\t [1] Kien Hung Ly "
    << "(s3977367@student.rmit.edu.au)" << std::endl;
    std::cout << "\t [2] Nathan Yong " 
    << "(s4090456@student.rmit.edu.au)" << std::endl;
    std::cout << "\t [3] Talin Russo-Christoffelsz "
    << "(s4106649@student.rmit.edu.au)" << std::endl;
